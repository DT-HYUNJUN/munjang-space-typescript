...
const Modal = (props: Props) => {
  ...
  // 검색한 책 클릭 이벤트
  const handleClickBook = (title: string, cover: string, description: string, author: string, isbn13: string, check: IReport) => {
    if (check) {
  ...
  return (
    <Container>
      ...
      <FormWrapper onSubmit={handleSubmit}>
        <TitleInput type="text" value={inputTitle} onChange={handleInput} placeholder="책 이름 검색" required />
                    ...
                    >
                      ...
                      <BookDetail>
                        <BookTitleWrapper>
                          ...
                          {props.reportList && props.reportList.find((report) => report.book.isbn13 === it.isbn13) && <FontAwesomeIcon ref={checkRef} icon={faCheckCircle} color="#337ab7" />}
                        </BookTitleWrapper>
